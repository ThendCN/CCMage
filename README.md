...
### 🔥 v1.2.2 - AI 费用追踪 + 内网穿透 (2025-12-01)

**全新功能上线！精确掌控 AI 费用，一键实现内网穿透**
...
- ✅ **费用可视化** - 清晰的费用趋势图和统计报表
- ✅ **精确定价** - 支持 Claude Sonnet 4.5/4.0、Opus 4.0 等模型

**使用场景**
```
📊 查看今天花了多少钱？
→ 打开"AI 编程" Tab → 点击"费用统计"
...
```
🌍 需要给客户演示本地项目？
→ 项目详情页 → 快捷操作 → Frpc 配置 → 一键启动

📱 想在手机上测试前端页面？
→ 配置 Frpc 后获得公网地址，随时访问
...
**智能的端口识别和冲突解决**
- ✅ **前后端分离** - 区分前端端口和后端端口
- ✅ **类型识别** - 自动识别 frontend/backend/fullstack 项目
- ✅ **关联管理** - 前后端项目互相关联
- ✅ **冲突检测** - 自动检测端口占用并提供建议
...
#### 📊 新增文档
- `AI_COST_TRACKING_GUIDE.md` - AI 费用追踪功能详解
- `AI_DIAGNOSIS_GUIDE.md` - AI 诊断功能使用指南
- `POLLING_OPTIMIZATION.md` - 轮询优化技术方案
- `PORT_SIMPLIFICATION.md` - 端口管理简化说明
